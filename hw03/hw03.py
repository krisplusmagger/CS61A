...
def pingpong(n):
    ...
    # def helper2(result, i, step):
    #     if i == n:
    #         return result
    #     elif i % 8 == 0 or num_eights(i) > 0:
    #         return helper2(result - step, i + 1, -step)
    #     else:
    #         return helper2(result + step, i + 1, step)

    # return helper2(1,1,1)


    # flag = 1  
    # def helper(i,temp = 0):
    #     if i > 10:
    #         if i % 10 != 8 and i // 8 != 0 and flag == 1:
    #             temp += 1
    #         elif i % 10 != 8 and i // 8 != 0 and flag == 0:
    #             temp -= 1
    #         elif i % 10 == 8 or i // 8 == 0:
    #             flag =abs(flag - 1)
    #     else:
    #         if i <= 8:
    #             temp +=1
